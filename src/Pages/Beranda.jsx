      ...
      <div className="linear-gradient">
        <Container>
          <Row>
            ...
            <Col md={6} className="background-image" style={{ backgroundImage: `url(${backgroundImage})`, minHeight: "300px", backgroundSize: "cover" }} data-aos="fade-left" data-aos-duration="3000"></Col>
          </Row>
        </Container>
      </div>
          ...
          <Row>
            <Col className="mt-3" data-aos="fade-up" data-aos-duration="1000">
              <div className="d-flex justify-content-between align-items-center">
                <h1 className="m-0">Para Seniman Kami</h1>
                <Link to="/seniman">
                  <FaArrowRightLong size={30} style={{ cursor: "pointer", color: "black" }} />
                </Link>
              </div>
